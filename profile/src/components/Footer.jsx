  ...
  <div className="container px-5 py-24 mx-auto">
    ...
    <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">We are a group of Developers</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">DiCE Labs</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      ...
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          <li>
            <a className="text-gray-600 hover:text-gray-800">cholahkuboko2gmail.com</a>
          </li>
          <li>
            <a className="text-gray-600 hover:text-gray-800">0979054417</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">

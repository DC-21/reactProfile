    ...
    <section className="text-gray-600 body-font">
      <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        ...
        <div className="text-center lg:w-2/3 w-full">
          ...
          <p className="mb-8 text-center md:text-left leading-relaxed text-lg font-medium-bold">As an experienced web developer with a passion for cybersecurity, I have honed my skills in both areas to create secure and reliable web applications.I am proficient in HTML, CSS, JavaScript, React, and various databases. Additionally, my expertise in cybersecurity allows me to implement robust security protocols and ensure the safety of data and users.</p>
